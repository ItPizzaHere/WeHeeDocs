...
[가상 면접 사례로 배우는 대규모 시스템 설계](../../review/study/system-design-interview.md)를 참조합니다.
...
자세한 내용은 [채팅 데이터베이스 테이블 설계](../../architecture/database/chatting-db-table.md)를 참고하세요.

# 시퀀스 다이어그램

자세한 내용은 [채팅 시퀀스 다이어그램]()을 참고하세요.
